...
EXPECTED_COLUMNS = {
    ...
    "trip_report_name": "varchar(255)",
    "event_report_name": "varchar(255)",
    "speed_event_rule_name": "varchar(255)",
    "idle_event_rule_name": "varchar(255)",
    "awh_event_rule_name": "varchar(255)",
    "ha_event_rule_name": "varchar(255)",
    "hb_event_rule_name": "varchar(255)",
    "hc_event_rule_name": "varchar(255)",
    "wu_event_rule_name": "varchar(255)",
    "wh_event_rule_name": "varchar(255)",
    "tag_id": "varchar(50)",
